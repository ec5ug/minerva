...
class UserInfo(models.Model):
    ...
    age = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(123)])
    edu_lvl = models.CharField(max_length=20)
    state = models.CharField(max_length=14)
    county = models.CharField(max_length=30)
    school = models.CharField(max_length=50)
    gpa = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(5)])
